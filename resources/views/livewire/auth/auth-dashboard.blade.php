...
<head>
    ...
    .col-lg-3 {
        flex: 0 0 24%; /* Adjust width so that 4 cards fit in a row */
        max-width: 24%; /* Equal width for all cards */
        margin-right: 1%; /* Add margin between cards */
    }
    .card {
        display: flex;
        flex-direction: column; 
    ...
    /* Card header styles */
    .reception-venue-card .card-header {
        background-color: #6d44b8; 
        color: #fff;
    }

    .reception-contacts-card .card-header {
        background-color: #6d44b8; 
        color: #fff;
        text-align: center;
    }
    ...
    <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Welcome, Clients!</h1>
                            </div>
                        </div>
                    </div>
                </div>
        <!-- Main content -->
            <div class="row">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="card widget recent-activities-card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('events') }}" class="btn btn-primary">See All</a>
                        </div>
                    </div>
                </div>
                ...
                <!-- Reception Venue Card -->
                <div class="col-lg-3 mb-4">
                    <div class="card widget reception-venue-card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-map-marker-alt"></i> Reception Venue</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <a href="{{ route('venues') }}" class="btn btn-primary">See All</a>
                        </div>
                    </div>
                </div>
                ...
                <!-- Reception Contacts Card -->
                <div class="col-lg-3 mb-4">
                    <div class="card widget reception-contacts-card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-address-book"></i> Reception Contacts</h3>
                        </div>
                        <div class="card-body">
                            <ul>
                                <li><strong>Event Planner:</strong> Richard Olarte - 09356281234</li>
                                <li><strong>Caterer:</strong> Emerich Fining - 09586732114</li>
                                <li><strong>Photographer:</strong> JJ Photograpy - 09675438762</li>
